$(document).ready(function() {
    ...
    function createD(top, ax, dir) {
        return "M0,0 " + top + ",0 a" + ax + ",200 0 1," + dir + " 0,400 L0,400";
    }

    var startD = createD(100, 0, 1),
        midD = createD(125, 75, 0),
        finalD = createD(550, 0, 1),
        clickMidD = createD(300, 150, 0),
        clickMidDRev = createD(550, 100, 1),
        clickD = createD(600, 0, 1),
        currentPath = startD;
